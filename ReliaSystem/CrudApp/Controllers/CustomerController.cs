...
namespace CrudApp.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        {
            string recepientName = "CrudApp Tester"; //         <===== Put the recepient's name here
            string recepientEmail = "test@crudapp.gmail.com"; //   <===== Put the recepient's email here

            string message = EmailTemplates.GetTestEmail(recepientName, DateTime.UtcNow);

            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from CrudApp", message);
