...
namespace CrudApp
{
    ...
    {
        public const string ApiName = "crudapp_api";
        public const string ApiFriendlyName = "CrudApp API";
        public const string CrudAppClientID = "crudapp_spa";
